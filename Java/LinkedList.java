public class LinkedList <T extends Number & Comparable<? super T>> {
    ...
    public void attach(LinkedList<T> ll, int pos) {
    ...
    public void sort() {
        if (size > 1) {
            ...
            while (curr != null) {
                next = curr.next;
                if (curr.data.compareTo(rear.data) > 0) {
                    rear.next = curr;
                } else if (curr.data.compareTo(front.data) < 0) {
                    curr.next = front;
                    front = curr;
                } else {
                    Node prev = front;
                    ...
                    while (shift != rear) {
                        if (curr.data.compareTo(shift.data) < 0) {
                            prev.next = curr;
                            curr.next = shift;
                            break;
                        }
